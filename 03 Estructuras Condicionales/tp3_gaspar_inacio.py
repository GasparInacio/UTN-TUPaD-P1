...
def ejercicio_9():
    ...
    magnitud = float(input('Ingrese la magnitud del terremoto (Richter): '))
...
def ejercicio_10():
    '''Utilizando la información aportada en la siguiente tabla sobre las estaciones del año
        ...
        Desde el 21 de 
        diciembre hasta el            Invierno                              Verano
        ...
        el 20 de septiembre            Verano                              Invierno
        (incluidos)
    ...
    mes = int(input('¿En qué mes del año es? (1-12): '))
